    ...
    var __webpack_modules__ = [
        ...
        (__unused_webpack_module, exports, __w_pdfjs_require__) => {
          ...
          function getDocument(t) {
            ...
            const d = t.verbosity,
              ...
              L =
                t.filterFactory ||
                new DefaultFilterFactory({ docId: i, ownerDocument: C });
                ...
                const t = _fetchDocument(c, N),
                  o = new Promise(function (t) {
                    ...
                    if (l)
                      ...
                      e = ((t) =>
                        _util.isNodeJS
                          ? new _displayNode_stream.PDFNodeStream(t)
                          : (0, _display_utils.isValidFetchUrl)(t.url)
                            ? new _displayFetch_stream.PDFFetchStream(t)
                            : new _displayNetwork.PDFNetworkStream(t))({
                        url: s,
                        length: F,
                        httpHeaders: a,
                        withCredentials: r,
          ...
          class AnnotationStorage {
            ...
            get serializable() {
              ...
              for (const [i, a] of this.#_) {
                const r =
                  a instanceof n.AnnotationEditor ? a.serialize(!1, s) : a;
                if (r) {
                  t.set(i, r);
          ...
          class AnnotationEditor {
            ...
            #H(t, e) {
              ...
              if (g) {
                ...
                y = S = Math.max(
                  Math.min(
                    Math.hypot(b[0] - f[0] - E, b[1] - f[1] - x) / t,
                    1 / r,
                    1 / o,
                  ),
                  l / r,
                ...
                m
                  ? (y =
                      Math.max(l, Math.min(1, Math.abs(b[0] - f[0] - E))) / r)
                  : (S =
                      Math.max(h, Math.min(1, Math.abs(b[1] - f[1] - x))) / o);
              const T = round(r * y),
                P = round(o * S);
              A = transf(...p(T, P));
              const M = _ - A[0],
        ...
        (t, e, i) => {
          ...
          class AnnotationEditorUIManager {
            ...
            #Ht(t) {
              Object.entries(t).some(([t, e]) => this.#Mt[t] !== e) &&
            ...
            removeEditor(t) {
              this.#et.delete(t.id);
              this.unselect(t);
              (t.annotationElementId && this.#ot.has(t.annotationElementId)) ||
                this.#nt?.remove(t.id);
            }
            ...
            #Gt() {
              ...
              if (1 === this.#et.size)
                for (const t of this.#et.values()) return t.isEmpty();
              return !1;
            }
            delete() {
              this.commitOrRemove();
            ...
            endDragSession() {
              ...
              for (const [{ x: i, y: s, pageIndex: n }, a] of t) {
                ...
                a.newPageIndex = n;
                e ||=
                  i !== a.savedX || s !== a.savedY || n !== a.savedPageIndex;
              }
              if (!e) return !1;
              const move = (t, e, i, s) => {
                if (this.#et.has(t.id)) {
              ...
              this.addCommands({
                ...
                undo: () => {
                  for (const [
                    e,
                    { savedX: i, savedY: s, savedPageIndex: n },
                  ] of t)
                    move(e, i, s, n);
                },
                mustExec: !0,
        ...
        (t, e, i) => {
          ...
          class DOMFilterFactory extends s.BaseFilterFactory {
            ...
            #ae(t) {
              ...
              return getRGB(
                getComputedStyle(this.#ie).getPropertyValue("color"),
              );
            }
          }
          ...
          class DOMStandardFontDataFactory
            extends s.BaseStandardFontDataFactory
          {
            _fetchData(t) {
          ...
          class CanvasGraphics {
            ...
            _scaleImage(t, e) {
              ...
              for (; (r > 2 && l > 1) || (o > 2 && h > 1); ) {
                ...
                if (o > 2 && h > 1) {
                  i =
                    h >= 16384 ? Math.floor(h / 2) - 1 || 1 : Math.ceil(h) / 2;
                  o /= h / i;
                }
            ...
            _createMaskCanvas(t) {
              ...
              const x = s.Util.transform((0, n.getCurrentTransformInverse)(y), [
                1,
                0,
                0,
                1,
            ...
            shadingFill(t) {
              ...
              if (r) {
                const { width: t, height: i } = e.canvas,
                  [n, a, o, l] = s.Util.getAxialAlignedBoundingBox(
                    [0, 0, t, i],
                    r,
                  );
          ...
          e.OptionalContentConfig = class OptionalContentConfig {
            ...
            constructor(t) {
              ...
              if (null !== t) {
                ...
                if ("OFF" === t.baseState)
                  for (const t of this.#Ae.values()) t._setVisible(a, !1);
          ...
          class NetworkManager {
            ...
            onStateChange(t, e) {
              ...
              if (206 === a) {
                ...
                r ? i.onDone({ begin: 0, chunk: r }) : i.onError?.(n.status);
            }
            getRequestXhr(t) {
          ...
          class PDFNodeStreamFsFullReader extends BaseFullReader {
            constructor(t) {
              ...
              i.lstat(e, (t, n) => {
                if (t) {
                  "ENOENT" === t.code &&
                    (t = new s.MissingPDFException(`Missing PDF "${e}".`));
                  this._storedError = t;
                  this._headersCapability.reject(t);
                } else {
          ...
          e.SVGGraphics = class SVGGraphics {
            ...
            shadingFill(t) {
              const { width: e, height: i } = this.viewport,
                ...
                [a, r, o, l] = n.Util.getAxialAlignedBoundingBox(
                  [0, 0, e, i],
                  s,
                ),
              ...
              this.current.fillAlpha < 1 &&
                h.setAttributeNS(null, "fill-opacity", this.current.fillAlpha);
          ...
          class AnnotationEditorLayer {
            ...
            pointerup(t) {
              ...
              if (
                ...
                this.#Pe = !1;
                this.#Ee
                  ? this.#Fe.getMode() !== s.AnnotationEditorType.STAMP
                    ? this.#De(t, !1)
                    : this.#Fe.unselectAll()
                  : (this.#Ee = !0);
              }
          ...
          class FreeTextEditor extends a.AnnotationEditor {
            ...
            getInitialTranslation() {
              ...
              return [
                ...
                -(FreeTextEditor._internalPadding + this.#We) * t,
              ];
            }
            rebuild() {
              if (this.parent) {
        ...
        (t, e, i) => {
          ...
          class AnnotationElement {
            ...
            setRotation(t, e = this.container) {
              ...
              const { pageWidth: i, pageHeight: s } =
                ...
                n &&
                  (t[n] = () => {
                    this.linkService.eventBus?.dispatch(
                      ...
                      { source: this, detail: { id: e.id, name: s } },
                    );
                    return !1;
                  });
              }
          ...
          class PopupElement {
            ...
            constructor({
              ...
              u &&
                (this.#ei = l.l10n.get("annotation_date_string", {
              ...
              if (this.#je) {
                ...
                if (
                  ...
                  r.style.backgroundColor = s.Util.makeHexColor(
                    ...this.#je.map((e) => Math.floor(t * (255 - e) + e)),
                  );
                }
              }
            ...
            #si(t) {
              t.altKey ||
                ...
                t.ctrlKey ||
                t.metaKey ||
                (("Enter" === t.key || ("Escape" === t.key && this.#gi)) &&
                  this.#hi());
            }
            #hi() {
              this.#gi = !this.#gi;
          ...
          class StampEditor extends n.AnnotationEditor {
            ...
            #Fs(t) {
              ...
              if (this.#Es) {
                const [t, e] = this.pageDimensions,
                  i = Math.round(
                    this.width * t * a.PixelsPerInch.PDF_TO_CSS_UNITS,
                  ),
                  s = Math.round(
                    this.height * e * a.PixelsPerInch.PDF_TO_CSS_UNITS,
                  ),
